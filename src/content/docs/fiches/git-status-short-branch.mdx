---
title: Interpréter git status -sb
description: Comprendre les codes d'état et les informations de synchronisation affichés par git status en format court.
slug: git-status-short-branch
topic: git
section: systeme
sidebar:
  label: "Interpréter git status"
---
