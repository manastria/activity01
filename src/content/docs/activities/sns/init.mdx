...
- **Interfaces :** Dans **Configuration > Réseau > Interfaces**, configurez vos interfaces (IN, OUT, DMZ) en leur attribuant des adresses IP statiques. Il est nécessaire de sortir les interfaces du « _bridge_ » par défaut.
...
2. **Dupliquer une politique existante**
   ...
   - Choisir un emplacement libre (typiquement les politiques 5 à 8).
